# Operator Quickstart — Growing Of Other Perennial Crops Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0129** (`cloud-itonami-isic-0129`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0129.git
cd cloud-itonami-isic-0129
```
...
- Blueprint governor key: `perennial-governor`
- Likely source path: `perennial.governor.cljc`
