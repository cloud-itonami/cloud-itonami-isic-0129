# Business Model: Growing Of Other Perennial Crops Coordination
...
## Classification
- Repository: `cloud-itonami-isic-0129` ([github.com/cloud-itonami/cloud-itonami-isic-0129](https://github.com/cloud-itonami/cloud-itonami-isic-0129))
- ISIC Rev.5: `0129` — Growing Of Other Perennial Crops Coordination
- Domain: `:agriculture/other-perennial-crop-cultivation`
- Social impact: :rural-livelihoods :farm-labor-efficiency :pesticide-safety
- Actor: `:perennial-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :agriculture/other-perennial-crop-cultivation — who wants
...
One managed tenant (:agriculture/other-perennial-crop-cultivation):
...
- Do not bypass the `:perennial-governor` for production decisions.
